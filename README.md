...
Maybe you could assign each function a number, and store that number to be called. For example, having 'full_caster_progression' be assigned 1, so if you Have Wizard, 1 it calls one and runs the appropriate function. It is something I will look into.
